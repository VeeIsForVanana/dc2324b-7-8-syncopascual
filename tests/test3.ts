...
test.describe('cookie history tests', () => {
    ...
    test(`visiting first user page followed by ${usersToVisit} creates correct history in cookies`, async ({
        context,
        page,
    }) => {
        await context.clearCookies();
    ...
    test(`visiting first user page followed by ${usersToVisit} creates correct history on pages`, async ({
        context,
        page,
    }) => {
        await context.clearCookies();
